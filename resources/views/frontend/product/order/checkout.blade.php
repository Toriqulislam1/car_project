                    ...
                    <div class="common-heading text-l">
                        ...
                        <div class="contact-form-card-pr contact-block-sw m0 iconin">
                                ...
                                <form action="{{ route('product-checkout-store') }}" id="contactform" method="post" novalidate="novalidate">
                                    ...
                                    <div class="fieldsets row">
                                        <div class="col-md-6 form-group floating-label">
                                            ...
                                            <input type="number" placeholder=" " value="" email required="required" id="email" class="floating-input" name="qty">
                                    ...
                                    <div class="fieldsets row">
                                        ...
                                        {{-- <div class="col-md-4 form-group floating-label">
                                            <div class="form-group col-sm-6">
                                                <span>@lang('lang.TemplateName')</span>
                                                <select name="carModel" id="Dtype" required>
                                                    <option>@lang('lang.SelectTemplate')</option>
                                                    @php
                                                    $models = App\Models\gallery::all();
                                                    @endphp
                                    ...
                                    <div class="fieldsets row">
                                        ...
                                        <div class="col-md-6 form-group floating-label">
                                            ...
                                            <div style="display: flex;">
                                                ...
                                                <input type="button" value="Set" onclick="display2.value =  'set-'" class="operator">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="product[]" id="inlineCheckbox1" value="{{ $item->id}}">
