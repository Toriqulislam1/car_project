            ...
            <div class="invoice-details-flex">
                <div class="invoice-single-details">
                    ...
                    <ul class="details-list">
                        <li class="list">order: <a href="#"></a>{{ $products->order_number  }} </li>
                    </ul>
                </div>
        ...
        <div class="item-description">
            <div class="table-responsive">
                ...
                <table class="custom--table">
                    ...
                    <tr>
                        <td>
                            <span class="data-span"> {{ __('Name: ') }}</span>{{ $products->name }} <br>
                            <span class="data-span"> {{ __('Email: ') }}</span> {{ $products->email  }} <br>
                            <span class="data-span"> {{ __('Phone: ') }}{{ $products->phone  }} <br>
                            <span class="data-span"> {{ __('Address: ') }}</span>{{ $products->location}}
