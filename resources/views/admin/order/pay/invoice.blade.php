...
@php
$orderinfo = App\Models\order::where('id',$service->order_id)->get();
@endphp
    ...
    <div class="invoice-wrapper">
            ...
            <div class="invoice-details-flex">
                <div class="invoice-single-details">
                    ...
                    <ul class="details-list">
                        ...
                        <li class="list">order: <a href="#"></a>{{ $orderinfo->first()->order_num  }} </li>
                    </ul>
                </div>
        ...
        <div class="item-description">
            <div class="table-responsive">
                <h5 class="table-title">{{ __('Payment details') }}</h5>
                <table class="custom--table">
                    ...
                    <tr>
                        <td>
                            ...
                            <span class="data-span"> {{ __('price:') }} {{ $service->price }}</span><br>
                            <span class="data-span"> {{ __('discount:') }}{{ $service->discount }} </span><br>
                            <span class="data-span"> {{ __('Total:') }} {{ $service->price - $service->discount }} </span><br>
